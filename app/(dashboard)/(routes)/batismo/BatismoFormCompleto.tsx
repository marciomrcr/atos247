...
export default function BatismoFormCompleto({ cells }: { cells: Cell[] }) {
  const {
    handleSubmit,
    register,
    reset,  
    ...
    <div className={isOpen ? "modal modal-open" : "modal"}>
        ...
        <div className="space-y-2">
            ...
            <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className={`block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-5 pl-2 ${
          ...
          <div className="border-b border-gray-900/10 pb-4">
            <h2 className="text-base font-semibold leading-2 text-gray-900">Informações Pessoais</h2>
