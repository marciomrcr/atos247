  ...
  return (
    <div>
      ...
      <div>
              ...
              <select
                className={`mb-3 w-full input input-bordered ${errors.redeMaeId ? "input-error" : ""
                  }`}
                {...register("redeMaeId", { required: true })}
              >
              ...
              {errors.redeMaeId && (
                <p className="text-red-500">{errors.redeMaeId.message}</p>
              )}
            </div>
      <div>
